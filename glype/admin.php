...
OUT;
		...
		function updateLatestVersion(response) {
			document.getElementById('current-version').innerHTML = '<imgBottom src="http://www.glype.com/feeds/proxy-version.php?cb={$cache_bust}" border="0" alt="version" />';
		}
OUT;
...
OUT;
		...
		window.loadingImage = '<imgBottom src="{$self}?image=loading.gif" width="16" height="16" alt="loading...">';
