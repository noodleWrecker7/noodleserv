...
<head>
    ...
    <link rel="icon" type="image/ico" href="favicon.ico" /> <!--Used from https://fontawesome.com under license https://fontawesome.com/license-->
</head>
...
<div class="main">
    ...
    <div class="content-chunk">
        ...
        <div class="content">
            ...
            <p class="main-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                nisi ut
                aliquip ex ea commodo consequat.</p>
            <p class="subtext">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                ut
    ...
    <div class="content-chunk dark-grey">
        <div class="content" style="padding-bottom: 0px;">
            <p class="bottom-text">Some important text</p>
        </div>
    </div>
</div>
